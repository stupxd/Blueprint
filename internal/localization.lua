-- This will be needed for settings menu

if Blueprint.use_smods() then return end

-- Vanilla will only support default loc cuz yes.
local loc_table = Blueprint.load_mod_file('localization/en-us.lua', 'localization')
